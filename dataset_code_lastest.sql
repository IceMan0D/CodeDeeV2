...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2024 at 05:48 AM
...
CREATE TABLE `course` (
  ...
  `course_notsell` int(11) NOT NULL,
  `course_certificate` varchar(70) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `type_id` int(11) NOT NULL,
  `requirements` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `description` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `suitable_for` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `income` varchar(7) DEFAULT NULL,
  `30per` varchar(7) DEFAULT NULL,
...
(1, 1, 1, 'PHP แบบไว ๆ ใน 3 นาที', 40, 'https://www.youtube.com/watch?v=IFhboIz8Ap4'),
(2, 1, 2, 'มัดรวมให้แล้ว ! 14 คำสั่ง PHP ', 40, 'https://youtu.be/-r7dyqvXcEI'),
(3, 2, 1, 'การติดตั้ง XAMPP บน Windows', 40, 'https://youtu.be/jvMwiQDtk9k'),
(4, 3, 1, 'บทที่ 1 : สอน PHP จัดการฐานข้อมูลด้วย My sql', 40, 'https://youtu.be/K3XYF7-gDG8'),
(5, 3, 2, 'บทที่ 2 : สอน PHP ทำระบบ Register + Login', 3, 'https://youtu.be/yZrp8RpWVXU'),
...
INSERT INTO `rate` (`rate_id`, `course_id`, `total_score`, `user_voting`, `average_score`, `type_id`) VALUES
(1, 40, '4', '1', 4, '1'),
(2, 46, '3', '1', 3, '3'),
(3, 45, '1', '1', 1, '2'),
(4, 58, '2', '1', 2, '4');
...
CREATE TABLE `sale` (
  ...
  `finished_studying` int(11) NOT NULL,
...
(3, 11, 52, '999.00', 1, '1_f7ztMaMM0etsFHpEfkdiwA.png', '', '', 0, '', 3, 0),
(4, 1, 52, '999.00', 1, 'download.png', '', '', 0, '', 3, 0),
(5, 1, 53, '2290.00', 1, 'React Cover.jpg', '', '', 0, '', 3, 0),
(6, 1, 66, '200.00', 1, 'php_course.png', '', '', 0, '', 3, 0),
(7, 12, 40, '299.00', 1, 'sprint_boot.png', '', '', 0, '', 2, 0),
(8, 12, 54, '2300.00', 1, 'React Cover.jpg', '', '', 0, '', 3, 0),
(9, 1, 41, '2500.00', 1, 'php_course.png', '', '', 0, '', 2, 0);
...
(1, '', 'user1', '1234', 'Test User', 'Test@email.com', '31 หมู่ 6 ต.มะขามเตี้ย อ.เมือง จ.สุราษฎร์ธานี 84000', '0884566211', NULL, NULL, 3, '', ''),
...
(3, 'profile-user.png', 'pp', '1234', 'Nonthanan Sirikanon', '6540011027@email.psu.ac.th', '93/7, ถ.กระโรม, ต.โพธิ์เสด็จ อ.เมือง จ.นครศรีธรรมราช, 80000', '0884565877', 'A3 2แผ่น.JPG', '1234567891', 2, 'นักศึกษา', 'เรียนดีตอนตี2'),
...
(11, 'sprint_boot.png', 'ADAM1', '$2y$10$vEOgyf/V87KjQ', 'ADAM HUAK', 'NAMEADAMAWAE@GMAIL.COM', '55/55', '000000000', NULL, NULL, 3, '', 'ttt'),
(12, '', 'nongjang', '$2y$10$AA0lr1htM.BK1', 'jang', 'jang@gmail.com', 'x', 'x', NULL, NULL, 3, NULL, NULL),
(13, '', 'nongphee', '$2y$10$izpKCh/Epmoka', 'phee', 'phee@gmail.com', 'tst', '0641379818', NULL, NULL, 3, '', '');
...
CREATE TABLE `will_be_learned` (
  `will_be_learned_id` int(11) NOT NULL,
  `course_id` int(11) NOT NULL,
...
--
ALTER TABLE `basket`
  MODIFY `basket_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `course_content`
  MODIFY `course_content_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `type_course_content`
  MODIFY `type_content_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `will_be_learned`
  MODIFY `will_be_learned_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
